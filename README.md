...
* `server_jre_8`: based on `Oracle Java SE Server Runtime Environment 8 update 74 build 02`
...
* `jre_8`: based on `Oracle Java SE Runtime Environment 8 update 74 build 02`
* `jre_7`: based on `Oracle Java SE Runtime Environment 7 update 80 build 15`

* `jdk_latest`: pointed to `isuper/java-oracle:jdk_8`
* `jdk_8`: based on `Oracle Java SE Development Kit 8 update 74 build 02`
